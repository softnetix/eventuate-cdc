...
public class PublishedEvent implements BinLogEvent {
    ...
    public PublishedEvent(String id, String entityId, String entityType, String eventData, String eventType, BinlogFileOffset binlogFileOffset, Optional<String> metadata, Optional<String> extraData) {
        this.id = id;
